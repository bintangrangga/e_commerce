...
<body>
  ...
  <div class="navbar-left">
    ...
    <nav>
      ...
      <a href="#category_sofa.php" class="active">category</a>
  ...
  <div class="navbar-right">
    <form action="" method="POST">
        <div class="search-box">
          ...
          <button class="search-btn" name="cari_kategori_sofa">
  ...
  <section class="product-section green">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        <a href="description.php?id_product=<?= $row["id_product"]; ?>"><img src="file_foto/<?php echo $row ["image"]?>" alt="Sofa 1" /></a>
  ...
  <section class="product-section green">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        <a href="description.php?id_product=<?= $row["id_product"]; ?>"><img src="file_foto/<?php echo $row ["image"]?>" alt="Sofa 1" /></a>
        <p><?php echo $row ["nama_product"]?></p>
        <p>Rp. <?php echo number_format($row ["harga_product"], 0, ',', '.');?>
        <div class="btn-group">
