...
$product = query ("SELECT * FROM product WHERE category = 'cupboard'");

if (isset($_POST["cari_kategori_cupboard"])) {
  $product = cari_kategori_cupboard($_POST ["keyword"]);
}
?>
...
<head>
  ...
  <title>Cupboard category | Bintang Furniture</title>
...
<body>
  ...
  <div class="navbar-right">
    ...
    <div class="search-box">
      ...
      <button class="search-btn" name = "cari_kategori_cupboard">
  ...
  <section class="product-section green">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        <a href="description.php?id_product=<?= $row["id_product"]; ?>"><img src="file_foto/<?php echo $row ["image"]?>" alt="Cupboard 1" /></a>
